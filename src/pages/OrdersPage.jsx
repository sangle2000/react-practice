...
// ================= DANH SÁCH ĐƠN HÀNG =================
export function OrdersPage({ orders, onSelect, goTo }) {
  return (
    <div className="bg-white p-5 border border-slate-200 rounded-xl">
      ...
      {orders.length === 0 ? (
        <div className="py-10 text-center">
          <p className="mb-3 text-slate-400 text-sm">Bạn chưa có đơn hàng nào</p>
          <button onClick={() => goTo("shop")} className="font-medium text-slate-700 text-sm underline">
            Mua sắm ngay
          </button>
        </div>
      ) : (
